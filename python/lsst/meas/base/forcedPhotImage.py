...
`~lsst.meas.base.forcedPhotCoadd.ForcedPhotCoaddTask`).
"""
...
class ForcedPhotImageTask(lsst.pipe.base.CmdLineTask):
    ...
    `~lsst.meas.base.forcedPhotCcd.ForcedPhotCcdTask` and
    `~lsst.meas.base.forcedPhotCoadd.ForcedPhotCoaddTask`. It provides the
